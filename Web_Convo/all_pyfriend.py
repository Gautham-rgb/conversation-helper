...
def all_pyfriend_page() -> None:
    with shell("Ask All"):
        ...
        ui.label("Speak or type a situation, and the helper will use every saved profile as context.").classes(
            "text-slate-400"
        )
...
async def _answer(user_text: str) -> str:
    ...
    system = (
        "Be a concise social intelligence helper. Use these profiles as context when relevant:\n"
        f"{context}\n\n"
